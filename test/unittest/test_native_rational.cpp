...
TEST_CASE( "write_native_rational_in_decimal_fmt" ) {
    std::string str = "x = ";

    SECTION(""){
        REQUIRE(write_native_rational_in_decimal_fmt(str, NativeRational(1,5)));
        REQUIRE(str == "x = 0.2");
    }

    SECTION(""){
        REQUIRE(write_native_rational_in_decimal_fmt(str, NativeRational(1,50)));
        REQUIRE(str == "x = 0.02");
    }

    SECTION(""){
        REQUIRE(write_native_rational_in_decimal_fmt(str, NativeRational(16,5)));
        REQUIRE(str == "x = 3.2");
    }

    SECTION(""){
        REQUIRE(write_native_rational_in_decimal_fmt(str, NativeRational(1,2)));
        REQUIRE(str == "x = 0.5");
    }

    SECTION(""){
        REQUIRE(write_native_rational_in_decimal_fmt(str, NativeRational(1,20)));
        REQUIRE(str == "x = 0.05");
    }

    SECTION(""){
        REQUIRE(write_native_rational_in_decimal_fmt(str, NativeRational(7,2)));
        REQUIRE(str == "x = 3.5");
    }

    SECTION(""){
        REQUIRE(write_native_rational_in_decimal_fmt(str, NativeRational(3,10)));
        REQUIRE(str == "x = 0.3");
    }

    SECTION(""){
        REQUIRE(write_native_rational_in_decimal_fmt(str, NativeRational(3,1000)));
        REQUIRE(str == "x = 0.003");
    }

    SECTION(""){
        REQUIRE(write_native_rational_in_decimal_fmt(str, NativeRational(169,100)));
        REQUIRE(str == "x = 1.69");
    }

    SECTION(""){
        REQUIRE(write_native_rational_in_decimal_fmt(str, NativeRational(169,10)));
        REQUIRE(str == "x = 16.9");
    }

    SECTION("Approximation less than 1"){
        REQUIRE_FALSE(write_native_rational_in_decimal_fmt(str, NativeRational(1,3)));
    }

    SECTION("Approximation greater than 1"){
        REQUIRE_FALSE(write_native_rational_in_decimal_fmt(str, NativeRational(103,13)));
    }

    SECTION("Integer"){
        REQUIRE_FALSE(write_native_rational_in_decimal_fmt(str, NativeRational(7,1)));
    }
}
